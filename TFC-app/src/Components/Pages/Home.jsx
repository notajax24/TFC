      ...
      <div className="container mx-auto px-4 h-screen flex flex-col items-center justify-center md:justify-center pt-20 md:pt-0">
        ...
        <div className="text-center relative z-10">
          <h1 className="text-5xl md:text-7xl font-bold mb-8">
            <span className="text-slate-200"> Sculpt your </span>
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-8">
            ...
            <span className="text-slate-200"> Your Mind!</span>
          </h1>
        ...
        <div className="md:hidden w-full mt-8 px-4">
          <div className="grid grid-cols-2 gap-4">
            {[
              { value: "500+", label: "Members", icon: <FaUserFriends /> },
              { value: "50+", label: "Trainers", icon: <FaDumbbell /> },
