...
const ExerciseCard = ({ exercise }) => {
  ...
  return (
    <div
      className="w-64 md:w-80 h-80 md:h-96 flex-shrink-0 cursor-pointer group perspective-1000"
      ...
      >
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 p-6 w-full">
            <span className="inline-block px-3 py-1 mb-2 text-xs font-bold tracking-wider text-orange-400 uppercase bg-orange-500/10 rounded-full border border-orange-500/20 backdrop-blur-md">
              {exercise.muscle}
            </span>
            <h3 className="text-2xl font-bold text-white mb-1">{exercise.name}</h3>
            <p className="text-xs text-gray-400 mt-2 flex items-center gap-1 group-hover:text-orange-300 transition-colors">
        ...
        >
          ...
          <div className="relative z-10 text-center">
            <h3 className="text-xl font-bold text-orange-400 mb-4 uppercase tracking-widest border-b border-gray-700 pb-2">
              Technique Guide
            </h3>
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-4 mb-12">
        <div className="text-center mb-10 space-y-4">
          <motion.h2
            ...
            className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500"
          >
            Train Smarter,
            <span className="block mt-2 text-orange-500">Unleash Potential</span>
          </motion.h2>
          <p className="text-gray-400">Tap on any card to view the technique guide.</p>
        </div>
      </div>

      {/* Infinite Scroll Container */}
      <div className="relative w-full border-y border-gray-800/50 bg-gray-900/20 backdrop-blur-sm py-12">
